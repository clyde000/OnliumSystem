...
const navItems = [
  ...
  { label: "Student Management",                 icon: "students",     to: "/admin/students",
    sub: [
      { label: "Students List", to: "/admin/students", tab: "list" },
      { label: "Demographics",  to: "/admin/students", tab: "demographics" },
      { label: "Applications",  to: "/admin/students", tab: "application" },
    ]
  },
